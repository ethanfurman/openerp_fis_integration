...
class TestEnum(unittest.TestCase):
    ...
    def test_AutoNumberEnum_and_init(self):
        class Color(aenum.AutoNumberEnum):
            ...
            blue = 5, 6
        self.assertEqual(Color.red.value, 1)
        self.assertEqual(Color.red.a, 'a')
        self.assertEqual(Color.red.b, 'b')
        self.assertEqual(Color.green.value, 2)
        self.assertEqual(Color.green.a, 'c')
        self.assertEqual(Color.green.b, 'd')
        self.assertEqual(Color.blue.value, 3)
        self.assertEqual(Color.blue.a, 5)
        self.assertEqual(Color.blue.b, 6)
