...
def _CC(stmt, vartbl, ptr, retval):
    ...
    ptr += 1
    mask = ".%" + '0%d' % postdec + "d"
    number = 1*256*256*ord(stmt[ptr]) + 256*ord(stmt[ptr+1]) + ord(stmt[ptr+2])
...
def _CD(stmt, vartbl, ptr, retval):
    ...
    ptr += 1
    number = 1*256*256*256*256*ord(stmt[ptr]) + 1*256*256*256*ord(stmt[ptr+1]) + 256*256*ord(stmt[ptr+2]) + 256*ord(stmt[ptr+3]) + ord(stmt[ptr+4])
...
def _CE(stmt, vartbl, ptr, retval):
    ...
    ptr += 1
    number = 0*256*256*256*256*256*ord(stmt[ptr]) + 1*256*256*256*256*ord(stmt[ptr+1]) + 1*256*256*256*ord(stmt[ptr+2]) + 256*256*ord(stmt[ptr+3]) + 256*ord(stmt[ptr+4]) + ord(stmt[ptr+5])
