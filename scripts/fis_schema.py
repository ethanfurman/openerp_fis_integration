...
class F140(FISenum):
    ...
    company_id        = 'An$(1,2)',     0     # Company Code
    code              = 'An$(3,6)',     1     # Customer No
    record_type_1     = 'An$(9,5)',     2     # Record Type ='1    '
    name              = 'Bn$',          3     # Ship To Name
    addr1             = 'Cn$',          4     # Addr Line 1
    addr2             = 'Dn$',          5     # Addr Line 2
    addr3             = 'En$',          6     # Addr Line 3
    postal            = 'Ln$',          7     # Zip Code
                                              # (open) - do not use Fn$(1,5)
    msi_cust          = 'Fn$(6,1)',     9     # MSI customer (Y/N)
    prc_list_id       = 'Fn$(7,1)',    10     # Price List Code
                                              # (open) Fn$(8,1)
    ord_print_msg     = 'Fn$(9,2)',    12     # ORD PRINT MSG
    inv_print_msg     = 'Fn$(11,2)',   13     # INV PRINT MSG
    oper_message      = 'Fn$(13,2)',   14     # OPER MESSAGE
    contact_frequency = 'Fn$(15,1)',   15     # CONTACT FREQUENCY
    pick_prior        = 'Fn$(16,1)',   16     # Pick Prior(1-9)
    day_contacted     = 'Fn$(17,1)',   17     # Day Contacted
    last_ord_dt       = 'Fn$(18,6)',   18     # Last Ord Dt
    last_inv_dt       = 'Fn$(24,6)',   19     # Last Inv Dt
    service_days      = 'Fn$(30,5)',   20     # Service Days
    holiday_gifts     = 'Fn$(35,1)',   21     # # Holiday Gifts
    last_ord_no       = 'Fn$(36,6)',   22     # Last Ord No
    last_inv_no       = 'Fn$(42,6)',   23     # Last Inv No
    service_rep       = 'Fn$(48,3)',   24     # Service Rep
    wrhse             = 'Fn$(51,4)',   25     # WAREHOUSE
    salesrep_id       = 'Fn$(55,3)',   26     # Salesrep Code
    route_id          = 'Fn$(58,3)',   27     # Route code
    stop_no           = 'Fn$(61,3)',   28     # Stop Number
    tax_auth          = 'Fn$(64,2)',   29     # TAX AUTH
    territory_id      = 'Fn$(66,3)',   30     # Territory Code
    source_id         = 'Fn$(68,2)',   31     # SOURCE CODE
    velocity_rpt      = 'Fn$(71,1)',   32     # Velocity Rpt(Y/N)
    catalog_catg      = 'Fn$(72,1)',   33     # Catalog Catg
    extra_labels      = 'Fn$(73,1)',   34     # # Extra Labels
    terms_id          = 'Fn$(74,1)',   35     # Terms Code
    build_up_items    = 'Fn$(75,1)',   36     # BUILD-UP ITEMS?
    delivery_days     = 'Fn$(76,3)',   37     # DELIVERY DAYS
    tele              = 'Fn$(79,10)',  38     # Telephone No
    key_acct_id       = 'Fn$(89,6)',   39     # Key Account Code
    ppd_collect       = 'Fn$(95,1)',   40     # PPD/Collect (P/C)
    sa_cat            = 'Fn$(96,2)',   41     # S/A Category
    prc_labels        = 'Fn$(98,1)',   42     # Price Labels (Y/N)
    pa_elg            = 'Fn$(99,1)',   43     # P/A Elg? (sp/N)
    prc_label_title_1 = 'Fn$(100,6)',  44     # Price Label Title - 1
    prc_label_title_2 = 'Fn$(106,6)',  45     # Price Label Title - 2
    order_days        = 'Fn$(112,5)',  46     # Order Days
    case_labels       = 'Fn$(117,1)',  47     # Case Labels?
    contract_prices   = 'Fn$(118,1)',  48     # Contract Prices?
    carrier_id        = 'Fn$(119,2)',  49     # Carrier Code
    broker_id         = 'Fn$(121,3)',  50     # Broker Code
                                              # (open) Fn$(124,1)
    temp_ar           = 'Bn',          52     # TEMP A/R $
    order_frequency   = 'Cn',          53     # ORDER FREQUENCY
    min_order_amt     = 'Dn',          54     # Min Order $ Amt
